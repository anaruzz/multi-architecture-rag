...
from basic_rag import run_query
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "basic_rag_predictions.jsonl")
...
for idx, row in tqdm(ref_df.iterrows(), total=len(ref_df), desc="Running Basic RAG"):
    query = row["query"]
